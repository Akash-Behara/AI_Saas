...
const ProModal = () => {
    ...
    const tools = [
        ...
        {label: 'Music Generation', icon: MusicIcon, color: 'text-emerald-500', bgColor: 'bg-emerald-500/10'},
        {label: 'Code Generation', icon: Code, color: 'text-violet-500', bgColor: 'bg-violet-500/10'}
      ]
